...
namespace SPCAF.Rules.MigrationAssessment
{
    [RuleMetadata(typeof(DeploymentAndProvisioningGroup),
        CheckId = "SMA267701",
        DisplayName = "Consider different implementation of WebTemplate",
        Description = "There is no direct replacement for WebTemplate in the App Model. WebTemplate are used during creation of a site and provisions ListTemplates, ContentTypes etc. The alternative implementation focusses on a completely different approach for site provisiong.",
        DefaultSeverity = Severity.CriticalError,
        SharePointVersion = new string[] { "12", "14", "15" },
        Message = "The WebTemplate '{0}' needs to be replaced which involves an alternative approach for provisioning of sites.",
        Resolution = "res:SPCAF.Rules.MigrationAssessment.Resources.SMA267701.html",
        Links = new string[]
        {
    ...
    public class WebTemplateRecommendations : Rule<WebTemplateDefinition>
    {
        public override void Visit(WebTemplateDefinition target, NotificationCollection notifications)
        {            
